...
echo "CDC-ECM Configuration" > configs/c.1/strings/0x409/configuration
echo 250                     > configs/c.1/MaxPower

# Create CDC-ECM function
mkdir -p functions/ecm.0
echo "00:22:82:ff:ff:11" > functions/ecm.0/dev_addr
echo "00:22:82:ff:ff:22" > functions/ecm.0/host_addr
